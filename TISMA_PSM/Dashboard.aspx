...
<asp:Content ID="Dashboard" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid" style="padding: 2rem 2rem 2rem 2rem" id="dashboard">
        ...
        <div class="row">
            <p style="font-size: 40px; font-weight: 700; color: red">TISMA<span style="color: grey">PKU</span>&nbsp&nbsp<span style="font-size:10px">Total Information System for Medical Administration</span></p>
            <hr />
        </div>
                ...
                <div class="row w-auto card-body">
                    <div class="col align-self-start">
                        <div class="row align-self-start">
                            <h1><asp:Literal runat="server" ID="getDoctorAvailable"></asp:Literal></h1>
                        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="card col align-self-start me-4" style="background: #38909a;">
                <div class="row w-auto card-body">
                    <div class="col align-self-start">
                        <div class="row align-self-start">
                            <h1><asp:Literal runat="server" ID="Literal1"></asp:Literal></h1>
                        </div>
                        <div class="row align-self-end">
                            <h5>Doctors Available</h5>
                        </div>
            ...
            <div class="card col align-self-start me-4" style="background: #fe8c00;">
                <div class="row w-auto card-body">
                    <div class="col align-self-start">
                        <div class="row align-self-start">
                            <h1><asp:Literal runat="server" ID="Literal2"></asp:Literal></h1>
                        </div>
                        <div class="row align-self-end">
                            <h5>Patients Waiting</h5>
                        </div>
